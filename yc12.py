"""
    Hiển thị danh sách các hóa đơn có thành tiền dưới 13 triệu đồng bán
trong tháng 5/2023
"""
...
print(f'Danh sách các hóa đơn có thành tiền dưới 13 triệu đồng, bán trong tháng 5/2023: ')
for info in data[:-1]:
    tmp = info.split()      #tmp = ['01:54:43', '27/09/2023', '1,12497,Pana,11,1,2,24000000.0,48000000.0']
    if float(tmp[2].split(',')[-1])<=13000000 and tmp[2].split(',')[4]=='5':
        print(info)