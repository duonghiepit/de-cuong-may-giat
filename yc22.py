"""
    Hiển thị danh sách tên các máy giặt đã bán trong tháng 2/2023 mà
không bán trong tháng 1/2023
"""
...
for info in data[:-1]:
    ...
    elif tmp[2].split(',')[4]=='2':
        lst_m2.append(tmp[2].split(',')[2])

print(lst_m1, lst_m2)
print(f'\nTên các máy giặt đã bán trong tháng 2/2023 mà không bán trong tháng 1/2023: {set(lst_m2)-set(lst_m1)}')